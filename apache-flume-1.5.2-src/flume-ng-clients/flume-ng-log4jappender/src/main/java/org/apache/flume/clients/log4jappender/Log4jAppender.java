...
public class Log4jAppender extends AppenderSkeleton {
  ...
  public synchronized void append(LoggingEvent event) throws FlumeException{
    ...
    //exception to show the appender is no longer accessible.
	  LogLog.error("=========start===abc======log4jAppender======append==========\n\n");
	  LogLog.error("rpcClient: " + rpcClient);
    ...
    if (rpcClient == null) {
	  ...
	  LogLog.error("rpcClient.isActive() : " + rpcClient.isActive());
    ...
    LogLog.error("message: " + message);
    if (message instanceof GenericRecord) {
    	LogLog.error("GenericRecord " );
