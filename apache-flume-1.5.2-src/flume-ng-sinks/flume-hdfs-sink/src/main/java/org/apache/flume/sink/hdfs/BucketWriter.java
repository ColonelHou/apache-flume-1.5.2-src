...
class BucketWriter {
  ...
  private volatile boolean inFileNameUseTimeStamp = true;
  ...
  BucketWriter(long rollInterval, long rollSize, long rollCount, long batchSize,
    ...
    int maxCloseTries, boolean inFileNameUseTimeStamp) {
	  this(rollInterval,
			  rollSize, rollCount,
			  batchSize, context, filePath, fileName, inUsePrefix, inUseSuffix,
			  fileSuffix, codeC, compType, writer, timedRollerPool,
			  user, sinkCounter, idleTimeout, onCloseCallback,
			  onCloseCallbackPath, callTimeout, callTimeoutPool, retryInterval,
			  maxCloseTries);
    this.inFileNameUseTimeStamp = inFileNameUseTimeStamp;
  }
  ...
  protected void renameBucket() throws IOException,
    InterruptedException {
	if (bucketPath == null || fileSystem == null || bucketPath.equals(targetPath)) {
		return;
	}
